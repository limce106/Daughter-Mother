...
public class TalkManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Talk1.Add("방에서 잠을 자고 있었던 00는 눈을 뜬다");
        Talk1.Add("어? 엄마... 어디갔어?");
        Talk1.Add("엄마없인 무서워서 못자는데 흐앙..");
        Talk1.Add("바닥에 저건 뭐지?");
        talk1.Add("엄마를 찾으러 가봐야겠다!");
        talk1.Add("<STAGE1 : 사라진 엄마 종료>");
        ...
        // 토끼 인형
        // ++ 이름 입력 완성 후 밑 코드도 변경
        Talk9.Add(PlayerPrefs.GetString("Name") + "아 안녕! 나를 구해줘서 고마워! 너랑 같이 학교에 가고 싶어서 몰래 들어왔는데 지퍼에 실이 끼어버렸지 뭐야");
